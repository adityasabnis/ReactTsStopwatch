...
describe("Stopwatch", () => {
  describe("initial render", () => {
    it("should correctly render Stopwatch correctly", () => {
      const { container } = render(<Stopwatch initialSeconds={0} />);
    ...
    it("should correctly render Stopwatch with non zero initial time", () => {
      const { container } = render(<Stopwatch initialSeconds={100} />);
      expect(container.querySelector(".stopwatch-timer").textContent).toBe(
        "1:40"
      );
    });
